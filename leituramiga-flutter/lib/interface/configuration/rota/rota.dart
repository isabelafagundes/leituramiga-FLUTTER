...
enum Rota {
  ...
  static List<AutoRoute> get rotasAuto => [
        adicionar(
          ...
          inicial: true,
          subrotas: [
            adicionar(rota: LOGIN, inicial: true, guards: []),
            adicionar(rota: CADASTRO_USUARIO, guards: []),
            adicionar(rota: SENHA, guards: []),
          ],
        ),
        adicionar(
          rota: AREA_LOGADA,
          subrotas: [
            adicionar(rota: HOME, inicial: true, guards: []),
            adicionar(rota: LIVRO, guards: []),
            adicionar(rota: SUPORTE, guards: []),
            adicionar(rota: USUARIO, guards: []),
            adicionar(rota: PERFIL, guards: []),
            adicionar(rota: CRIAR_LIVRO, guards: []),
            adicionar(rota: EDITAR_PERFIL, guards: []),
            adicionar(rota: SOLICITACAO, guards: []),
            adicionar(rota: DETALHES_SOLICITACAO, guards: []),
            adicionar(rota: CALENDARIO, guards: []),
